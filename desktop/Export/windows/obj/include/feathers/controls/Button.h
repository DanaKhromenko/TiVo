...
class HXCPP_CLASS_ATTRIBUTES Button_obj : public  ::feathers::controls::BasicButton_obj
{
	...
	public:
		...
		void __construct(::String text, ::Dynamic triggerListener);
		...
		static ::hx::ObjectPtr< Button_obj > __new(::String text, ::Dynamic triggerListener);
		static ::hx::ObjectPtr< Button_obj > __alloc(::hx::Ctx *_hx_ctx,::String text, ::Dynamic triggerListener);
		...
		bool _wrappedOnMeasure;
		 ...
		 ::feathers::text::TextFormat getTextFormatForState( ::feathers::controls::ButtonState state);
		::Dynamic getTextFormatForState_dyn();

		void setTextFormatForState( ::feathers::controls::ButtonState state, ::feathers::text::TextFormat textFormat);
		...
		void button_keyDownHandler( ::openfl::events::KeyboardEvent event);
		::Dynamic button_keyDownHandler_dyn();

		void button_focusInHandler( ::openfl::events::FocusEvent event);
		::Dynamic button_focusInHandler_dyn();

		void button_focusOutHandler( ::openfl::events::FocusEvent event);
		::Dynamic button_focusOutHandler_dyn();

		void button_textFormat_changeHandler( ::openfl::events::Event event);
		::Dynamic button_textFormat_changeHandler_dyn();

		void button_icon_resizeHandler( ::openfl::events::Event event);
		::Dynamic button_icon_resizeHandler_dyn();
