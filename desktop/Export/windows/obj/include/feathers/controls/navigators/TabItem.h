...
class HXCPP_CLASS_ATTRIBUTES TabItem_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::feathers::controls::navigators::TabItem withFactory(::String text, ::feathers::utils::DisplayObjectFactory viewFactory);
		static ::Dynamic withFactory_dyn();

		static int internalIDCounter;
		::String internalID;
		::String text;
		 ::feathers::utils::DisplayObjectFactory viewFactory;
