...
class HXCPP_CLASS_ATTRIBUTES BaseScrollContainer_obj : public  ::feathers::core::FeathersControl_obj
{
	...
	public:
		...
		virtual bool get_measureViewPort();
		...
		::Dynamic destroyScroller_dyn();

		void createScrollBars();
		::Dynamic createScrollBars_dyn();

		void createScrollBarX();
		::Dynamic createScrollBarX_dyn();

		void destroyScrollBarX();
		::Dynamic destroyScrollBarX_dyn();

		void createScrollBarY();
		::Dynamic createScrollBarY_dyn();

		void destroyScrollBarY();
		::Dynamic destroyScrollBarY_dyn();
		...
		void calculateViewPortOffsetsForFixedScrollBarX(bool useActualBounds);
		::Dynamic calculateViewPortOffsetsForFixedScrollBarX_dyn();

		void calculateViewPortOffsetsForFixedScrollBarY(bool useActualBounds);
		...
		virtual  ::openfl::display::DisplayObject getCurrentBackgroundSkin();
		::Dynamic getCurrentBackgroundSkin_dyn();

		virtual void addCurrentBackgroundSkin( ::openfl::display::DisplayObject skin);
		::Dynamic addCurrentBackgroundSkin_dyn();

		virtual void removeCurrentBackgroundSkin( ::openfl::display::DisplayObject skin);
		...
		virtual void baseScrollContainer_keyDownHandler( ::openfl::events::KeyboardEvent event);
