...
class HXCPP_CLASS_ATTRIBUTES LayoutViewPort_obj : public  ::feathers::controls::LayoutGroup_obj
{
	...
	public:
		...
		bool _manageChildVisibility;
		bool get_manageChildVisibility();
		::Dynamic get_manageChildVisibility_dyn();

		bool set_manageChildVisibility(bool value);
		::Dynamic set_manageChildVisibility_dyn();

		void update();

		void refreshChildVisibility();
		::Dynamic refreshChildVisibility_dyn();
