...
class HXCPP_CLASS_ATTRIBUTES PopUpManager_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::display::DisplayObject addPopUp( ::openfl::display::DisplayObject popUp, ::openfl::display::DisplayObject owner,::hx::Null< bool >  isModal,::hx::Null< bool >  isCentered, ::Dynamic customOverlayFactory);
