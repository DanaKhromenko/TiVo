...
class HXCPP_CLASS_ATTRIBUTES ScrollEvent_obj : public  ::openfl::events::Event_obj
{
	...
	public:
		...
		void __construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y);
		...
		static ::hx::ObjectPtr< ScrollEvent_obj > __new(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y);
		static ::hx::ObjectPtr< ScrollEvent_obj > __alloc(::hx::Ctx *_hx_ctx,::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y);
		...
		static bool dispatch(::Dynamic dispatcher,::String type,::hx::Null< bool >  bubbles,::hx::Null< bool >  cancelable,::hx::Null< Float >  x,::hx::Null< Float >  y);
