...
#define INCLUDED_feathers_motion_effects_actuate_MethodEffectActuator
...
HX_DECLARE_CLASS4(feathers,motion,effects,actuate,MethodEffectActuator)
...
class HXCPP_CLASS_ATTRIBUTES MethodEffectActuator_obj : public  ::motion::actuators::MethodActuator_obj
{
	public:
		typedef  ::motion::actuators::MethodActuator_obj super;
		typedef MethodEffectActuator_obj OBJ_;
		MethodEffectActuator_obj();

	public:
		enum { _hx_ClassId = 0x205122fe };

		void __construct( ::Dynamic target,Float duration, ::Dynamic properties);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="feathers.motion.effects.actuate.MethodEffectActuator")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"feathers.motion.effects.actuate.MethodEffectActuator"); }
		static ::hx::ObjectPtr< MethodEffectActuator_obj > __new( ::Dynamic target,Float duration, ::Dynamic properties);
		static ::hx::ObjectPtr< MethodEffectActuator_obj > __alloc(::hx::Ctx *_hx_ctx, ::Dynamic target,Float duration, ::Dynamic properties);
		...
		::String __ToString() const { return HX_("MethodEffectActuator",cb,6b,e9,bc); }
...
#endif /* INCLUDED_feathers_motion_effects_actuate_MethodEffectActuator */ 
