...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_827c4d25b15f5e0c_87_new)
...
HXDLIN(  87)		__this->super::__construct();
            	}
		...
		static  ::feathers::utils::DisplayObjectRecycler withFactory( ::feathers::utils::DisplayObjectFactory factory, ::Dynamic update, ::Dynamic reset);
		static ::Dynamic withFactory_dyn();
