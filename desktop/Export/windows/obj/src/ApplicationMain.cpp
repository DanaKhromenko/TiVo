...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("TiVo",2e,e4,d5,37),::ApplicationMain_obj::create_dyn());
...
HXLINE(  39)		app->meta->set(HX_("company",3d,15,69,83),HX_("Company Name",4e,48,0d,cb));
HXLINE(  40)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("TiVo",2e,e4,d5,37));
HXLINE(  41)		app->meta->set(HX_("name",4b,72,ff,48),HX_("TiVo",2e,e4,d5,37));
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.sample.tivo",05,5b,53,d7));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("TiVo",2e,e4,d5,37))
