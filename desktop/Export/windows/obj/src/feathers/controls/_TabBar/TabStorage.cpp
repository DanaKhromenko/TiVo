...
HX_DEFINE_STACK_FRAME(_hx_pos_601449c36b95fe07_1255_new,"feathers.controls._TabBar.TabStorage","new",0x760a9203,"feathers.controls._TabBar.TabStorage.new","feathers/controls/TabBar.hx",1255,0xc18603c6)
namespace feathers{
namespace controls{
namespace _TabBar{

void TabStorage_obj::__construct(::String id, ::feathers::utils::DisplayObjectRecycler recycler){
            	HX_STACKFRAME(&_hx_pos_601449c36b95fe07_1255_new)
HXLINE(1265)		this->inactiveTabs = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1264)		this->activeTabs = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(1257)		this->id = id;
HXLINE(1258)		this->tabRecycler = recycler;
            	}
