...
HXLINE(  62)			HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("DefaultPopUpManager root's stage property must not be null.",59,e3,50,d9)));
            		}
...
HXLINE(  75)				 ::openfl::display::DisplayObject popUp1 = _g3->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN(  75)				_g2 = (_g2 + 1);
HXLINE(  76)				 ::openfl::display::DisplayObject overlay1 = ( ( ::openfl::display::DisplayObject)(this->_popUpToOverlay->get(popUp1)) );
HXLINE(  77)				if (::hx::IsNotNull( overlay1 )) {
HXLINE(  78)					this->_root->addChild(overlay1);
            				}
HXLINE(  80)				this->_root->addChild(popUp1);
            			}
            		}
...
HXLINE( 331)				 ::openfl::display::DisplayObject popUp1 = _g3->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 331)				_g2 = (_g2 + 1);
HXLINE( 332)				this->centerPopUp(popUp1);
            			}
            		}
            	}
