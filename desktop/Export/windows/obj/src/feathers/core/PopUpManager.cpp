...
HXLINE(  75)			HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("PopUpManager stage argument must not be null.",ec,65,cb,08)));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(PopUpManager_obj,dispose,(void))
 ...
 ::openfl::display::DisplayObject PopUpManager_obj::addPopUp( ::openfl::display::DisplayObject popUp, ::openfl::display::DisplayObject owner,::hx::Null< bool >  __o_isModal,::hx::Null< bool >  __o_isCentered, ::Dynamic customOverlayFactory){
...
HXLINE( 111)		if (::hx::IsNull( owner )) {
HXLINE( 112)			HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("The pop-up's owner must not be null.",33,2c,1e,9e)));
            		}
HXLINE( 114)		 ::openfl::display::Stage stage = owner->stage;
HXLINE( 115)		if (::hx::IsNull( stage )) {
HXLINE( 116)			HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("The stage property of a pop-up's owner must not be null.",d2,72,6e,a7)));
            		}
...
HXLINE( 157)			HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,HX_("A pop-up's stage property must not be null.",83,d3,62,54)));
            		}
