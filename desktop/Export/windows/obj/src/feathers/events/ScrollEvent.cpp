...
HX_DEFINE_STACK_FRAME(_hx_pos_38997300b37a6a5f_97_new,"feathers.events.ScrollEvent","new",0x0f3cb488,"feathers.events.ScrollEvent.new","feathers/events/ScrollEvent.hx",97,0xb49f1e08)
HX_LOCAL_STACK_FRAME(_hx_pos_38997300b37a6a5f_118_clone,"feathers.events.ScrollEvent","clone",0x8e6b5185,"feathers.events.ScrollEvent.clone","feathers/events/ScrollEvent.hx",118,0xb49f1e08)
HX_LOCAL_STACK_FRAME(_hx_pos_38997300b37a6a5f_73_dispatch,"feathers.events.ScrollEvent","dispatch",0x6306d992,"feathers.events.ScrollEvent.dispatch","feathers/events/ScrollEvent.hx",73,0xb49f1e08)
...
void ScrollEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            		bool bubbles = __o_bubbles.Default(false);
            		bool cancelable = __o_cancelable.Default(false);
            		Float x = __o_x.Default(((Float)0.0));
            		Float y = __o_y.Default(((Float)0.0));
            	HX_STACKFRAME(&_hx_pos_38997300b37a6a5f_97_new)
HXLINE(  98)		super::__construct(type,bubbles,cancelable);
HXLINE(  99)		this->x = x;
HXLINE( 100)		this->y = y;
            	}
...
bool ScrollEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event ScrollEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_38997300b37a6a5f_118_clone)
HXDLIN( 118)		return  ::feathers::events::ScrollEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->x,this->y);
            	}
...
bool ScrollEvent_obj::dispatch(::Dynamic dispatcher,::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y){
            		bool bubbles = __o_bubbles.Default(false);
            		bool cancelable = __o_cancelable.Default(false);
            		Float x = __o_x.Default(((Float)0.0));
            		Float y = __o_y.Default(((Float)0.0));
            	HX_STACKFRAME(&_hx_pos_38997300b37a6a5f_73_dispatch)
HXLINE(  78)		 ::feathers::events::ScrollEvent event = ::feathers::events::ScrollEvent_obj::_pool->get().StaticCast<  ::feathers::events::ScrollEvent >();
HXLINE(  79)		event->type = type;
HXLINE(  80)		event->bubbles = bubbles;
HXLINE(  81)		event->cancelable = cancelable;
HXLINE(  82)		event->x = x;
HXLINE(  83)		event->y = y;
HXLINE(  84)		bool result = ::openfl::events::IEventDispatcher_obj::dispatchEvent(dispatcher,event);
HXLINE(  85)		::feathers::events::ScrollEvent_obj::_pool->release(event);
HXLINE(  86)		return result;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC6(ScrollEvent_obj,dispatch,return )


::hx::ObjectPtr< ScrollEvent_obj > ScrollEvent_obj::__new(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y) {
	::hx::ObjectPtr< ScrollEvent_obj > __this = new ScrollEvent_obj();
	__this->__construct(type,__o_bubbles,__o_cancelable,__o_x,__o_y);
	return __this;
}

::hx::ObjectPtr< ScrollEvent_obj > ScrollEvent_obj::__alloc(::hx::Ctx *_hx_ctx,::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y) {
...
::hx::Val ScrollEvent_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
...
void ScrollEvent_obj::__GetFields(Array< ::String> &outFields)
{
...
static ::hx::StorageInfo ScrollEvent_obj_sMemberStorageInfo[] = {
	{::hx::fsFloat,(int)offsetof(ScrollEvent_obj,x),HX_("x",78,00,00,00)},
	{::hx::fsFloat,(int)offsetof(ScrollEvent_obj,y),HX_("y",79,00,00,00)},
	{ ::hx::fsUnknown, 0, null()}
};
...
HXDLIN(  54)			return  ::feathers::events::ScrollEvent_obj::__alloc( HX_CTX ,null(),false,false,null(),null());
            		}
