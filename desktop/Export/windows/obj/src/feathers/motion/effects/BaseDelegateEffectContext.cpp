...
HX_LOCAL_STACK_FRAME(_hx_pos_0f1e3f1c7985f81b_75_get_position,"feathers.motion.effects.BaseDelegateEffectContext","get_position",0xa386a75e,"feathers.motion.effects.BaseDelegateEffectContext.get_position","feathers/motion/effects/BaseDelegateEffectContext.hx",75,0x2f2ab05d)
HX_LOCAL_STACK_FRAME(_hx_pos_0f1e3f1c7985f81b_78_set_position,"feathers.motion.effects.BaseDelegateEffectContext","set_position",0xb87fcad2,"feathers.motion.effects.BaseDelegateEffectContext.set_position","feathers/motion/effects/BaseDelegateEffectContext.hx",78,0x2f2ab05d)
HX_LOCAL_STACK_FRAME(_hx_pos_0f1e3f1c7985f81b_87_play,"feathers.motion.effects.BaseDelegateEffectContext","play",0x4b63f4a0,"feathers.motion.effects.BaseDelegateEffectContext.play","feathers/motion/effects/BaseDelegateEffectContext.hx",87,0x2f2ab05d)
HX_LOCAL_STACK_FRAME(_hx_pos_0f1e3f1c7985f81b_94_playReverse,"feathers.motion.effects.BaseDelegateEffectContext","playReverse",0xf3974062,"feathers.motion.effects.BaseDelegateEffectContext.playReverse","feathers/motion/effects/BaseDelegateEffectContext.hx",94,0x2f2ab05d)
HX_LOCAL_STACK_FRAME(_hx_pos_0f1e3f1c7985f81b_101_pause,"feathers.motion.effects.BaseDelegateEffectContext","pause",0xa4dbe6ca,"feathers.motion.effects.BaseDelegateEffectContext.pause","feathers/motion/effects/BaseDelegateEffectContext.hx",101,0x2f2ab05d)
HX_LOCAL_STACK_FRAME(_hx_pos_0f1e3f1c7985f81b_108_stop,"feathers.motion.effects.BaseDelegateEffectContext","stop",0x4d65b6ae,"feathers.motion.effects.BaseDelegateEffectContext.stop","feathers/motion/effects/BaseDelegateEffectContext.hx",108,0x2f2ab05d)
HX_LOCAL_STACK_FRAME(_hx_pos_0f1e3f1c7985f81b_115_toEnd,"feathers.motion.effects.BaseDelegateEffectContext","toEnd",0xfb92c4f4,"feathers.motion.effects.BaseDelegateEffectContext.toEnd","feathers/motion/effects/BaseDelegateEffectContext.hx",115,0x2f2ab05d)
HX_LOCAL_STACK_FRAME(_hx_pos_0f1e3f1c7985f81b_122_interrupt,"feathers.motion.effects.BaseDelegateEffectContext","interrupt",0x4f028377,"feathers.motion.effects.BaseDelegateEffectContext.interrupt","feathers/motion/effects/BaseDelegateEffectContext.hx",122,0x2f2ab05d)
HX_LOCAL_STACK_FRAME(_hx_pos_0f1e3f1c7985f81b_126_baseDelegateEffectContext_context_changeHandler,"feathers.motion.effects.BaseDelegateEffectContext","baseDelegateEffectContext_context_changeHandler",0x6e38bfc7,"feathers.motion.effects.BaseDelegateEffectContext.baseDelegateEffectContext_context_changeHandler","feathers/motion/effects/BaseDelegateEffectContext.hx",126,0x2f2ab05d)
HX_LOCAL_STACK_FRAME(_hx_pos_0f1e3f1c7985f81b_130_baseDelegateEffectContext_context_completeHandler,"feathers.motion.effects.BaseDelegateEffectContext","baseDelegateEffectContext_context_completeHandler",0x8a7d78de,"feathers.motion.effects.BaseDelegateEffectContext.baseDelegateEffectContext_context_completeHandler","feathers/motion/effects/BaseDelegateEffectContext.hx",130,0x2f2ab05d)
namespace feathers{
namespace motion{
namespace effects{
...
Float BaseDelegateEffectContext_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_0f1e3f1c7985f81b_75_get_position)
HXDLIN(  75)		return ::feathers::motion::effects::IEffectContext_obj::get_position(this->get_context());
            	}
...
Float BaseDelegateEffectContext_obj::set_position(Float value){
            	HX_STACKFRAME(&_hx_pos_0f1e3f1c7985f81b_78_set_position)
HXLINE(  79)		::feathers::motion::effects::IEffectContext_obj::set_position(this->get_context(),value);
HXLINE(  80)		return ::feathers::motion::effects::IEffectContext_obj::get_position(this->get_context());
            	}
...
void BaseDelegateEffectContext_obj::play(){
            	HX_STACKFRAME(&_hx_pos_0f1e3f1c7985f81b_87_play)
HXDLIN(  87)		::feathers::motion::effects::IEffectContext_obj::play(this->_context);
            	}
...
void BaseDelegateEffectContext_obj::playReverse(){
            	HX_STACKFRAME(&_hx_pos_0f1e3f1c7985f81b_94_playReverse)
HXDLIN(  94)		::feathers::motion::effects::IEffectContext_obj::playReverse(this->_context);
            	}
...
void BaseDelegateEffectContext_obj::pause(){
            	HX_STACKFRAME(&_hx_pos_0f1e3f1c7985f81b_101_pause)
HXDLIN( 101)		::feathers::motion::effects::IEffectContext_obj::pause(this->_context);
            	}
...
void BaseDelegateEffectContext_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_0f1e3f1c7985f81b_108_stop)
HXDLIN( 108)		::feathers::motion::effects::IEffectContext_obj::stop(this->_context);
            	}
...
void BaseDelegateEffectContext_obj::toEnd(){
            	HX_STACKFRAME(&_hx_pos_0f1e3f1c7985f81b_115_toEnd)
HXDLIN( 115)		::feathers::motion::effects::IEffectContext_obj::toEnd(this->_context);
            	}
...
void BaseDelegateEffectContext_obj::interrupt(){
            	HX_STACKFRAME(&_hx_pos_0f1e3f1c7985f81b_122_interrupt)
HXDLIN( 122)		::feathers::motion::effects::IEffectContext_obj::interrupt(this->_context);
            	}
...
void BaseDelegateEffectContext_obj::baseDelegateEffectContext_context_changeHandler( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_0f1e3f1c7985f81b_126_baseDelegateEffectContext_context_changeHandler)
HXDLIN( 126)		::feathers::events::FeathersEvent_obj::dispatch(::hx::ObjectPtr<OBJ_>(this),HX_("change",70,91,72,b7),null(),null());
            	}
...
void BaseDelegateEffectContext_obj::baseDelegateEffectContext_context_completeHandler( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_0f1e3f1c7985f81b_130_baseDelegateEffectContext_context_completeHandler)
HXDLIN( 130)		::feathers::events::FeathersEvent_obj::dispatch(::hx::ObjectPtr<OBJ_>(this),HX_("complete",b9,00,c8,7f),null(),null());
            	}
