...
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_81_get_position,"feathers.motion.effects.BaseEffectContext","get_position",0x9bbe5ab9,"feathers.motion.effects.BaseEffectContext.get_position","feathers/motion/effects/BaseEffectContext.hx",81,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_84_set_position,"feathers.motion.effects.BaseEffectContext","set_position",0xb0b77e2d,"feathers.motion.effects.BaseEffectContext.set_position","feathers/motion/effects/BaseEffectContext.hx",84,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_104_get_ease,"feathers.motion.effects.BaseEffectContext","get_ease",0x5ec5fdfe,"feathers.motion.effects.BaseEffectContext.get_ease","feathers/motion/effects/BaseEffectContext.hx",104,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_132_play,"feathers.motion.effects.BaseEffectContext","play",0xe16b54fb,"feathers.motion.effects.BaseEffectContext.play","feathers/motion/effects/BaseEffectContext.hx",132,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_116_play,"feathers.motion.effects.BaseEffectContext","play",0xe16b54fb,"feathers.motion.effects.BaseEffectContext.play","feathers/motion/effects/BaseEffectContext.hx",116,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_160_playReverse,"feathers.motion.effects.BaseEffectContext","playReverse",0x7c2a7167,"feathers.motion.effects.BaseEffectContext.playReverse","feathers/motion/effects/BaseEffectContext.hx",160,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_144_playReverse,"feathers.motion.effects.BaseEffectContext","playReverse",0x7c2a7167,"feathers.motion.effects.BaseEffectContext.playReverse","feathers/motion/effects/BaseEffectContext.hx",144,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_171_pause,"feathers.motion.effects.BaseEffectContext","pause",0x5548d60f,"feathers.motion.effects.BaseEffectContext.pause","feathers/motion/effects/BaseEffectContext.hx",171,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_191_stop,"feathers.motion.effects.BaseEffectContext","stop",0xe36d1709,"feathers.motion.effects.BaseEffectContext.stop","feathers/motion/effects/BaseEffectContext.hx",191,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_205_toEnd,"feathers.motion.effects.BaseEffectContext","toEnd",0xabffb439,"feathers.motion.effects.BaseEffectContext.toEnd","feathers/motion/effects/BaseEffectContext.hx",205,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_225_interrupt,"feathers.motion.effects.BaseEffectContext","interrupt",0x24b8f93c,"feathers.motion.effects.BaseEffectContext.interrupt","feathers/motion/effects/BaseEffectContext.hx",225,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_235_prepareEffect,"feathers.motion.effects.BaseEffectContext","prepareEffect",0x4004ff91,"feathers.motion.effects.BaseEffectContext.prepareEffect","feathers/motion/effects/BaseEffectContext.hx",235,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_244_updateEffect,"feathers.motion.effects.BaseEffectContext","updateEffect",0x7c110781,"feathers.motion.effects.BaseEffectContext.updateEffect","feathers/motion/effects/BaseEffectContext.hx",244,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_253_cleanupEffect,"feathers.motion.effects.BaseEffectContext","cleanupEffect",0x11aacdee,"feathers.motion.effects.BaseEffectContext.cleanupEffect","feathers/motion/effects/BaseEffectContext.hx",253,0xa7daaaf8)
HX_LOCAL_STACK_FRAME(_hx_pos_f314fcaef2849992_255_animatePlayback_onComplete,"feathers.motion.effects.BaseEffectContext","animatePlayback_onComplete",0xb359aa02,"feathers.motion.effects.BaseEffectContext.animatePlayback_onComplete","feathers/motion/effects/BaseEffectContext.hx",255,0xa7daaaf8)
namespace feathers{
namespace motion{
namespace effects{
...
HXLINE( 108)		this->_reversed = false;
HXLINE( 107)		this->_playing = false;
...
Float BaseEffectContext_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_81_get_position)
HXDLIN(  81)		return this->_position;
            	}
...
Float BaseEffectContext_obj::set_position(Float value){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_84_set_position)
HXLINE(  85)		if ((this->_position == value)) {
HXLINE(  86)			return this->_position;
            		}
HXLINE(  88)		this->_position = value;
HXLINE(  89)		this->updateEffect();
HXLINE(  90)		::feathers::events::FeathersEvent_obj::dispatch(::hx::ObjectPtr<OBJ_>(this),HX_("change",70,91,72,b7),null(),null());
HXLINE(  91)		return this->_position;
            	}
...
::Dynamic BaseEffectContext_obj::get_ease(){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_104_get_ease)
HXDLIN( 104)		return this->_ease;
            	}
...
void BaseEffectContext_obj::play(){
            		...
            		void _hx_run(Float value){
            			HX_STACKFRAME(&_hx_pos_f314fcaef2849992_132_play)
HXLINE( 132)			_gthis->set_position(value);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_116_play)
HXDLIN( 116)		 ::feathers::motion::effects::BaseEffectContext _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 117)		bool _hx_tmp;
HXDLIN( 117)		if (this->_playing) {
HXLINE( 117)			_hx_tmp = !(this->_reversed);
            		}
            		else {
...
HXLINE( 121)		if (::hx::IsNotNull( this->_animatePlayback )) {
HXLINE( 122)			::motion::Actuate_obj::stop(this->_animatePlayback,null(),false,false);
HXLINE( 123)			this->_animatePlayback = null();
            		}
HXLINE( 125)		this->_playing = true;
HXLINE( 126)		this->_reversed = false;
HXLINE( 128)		Float duration = (this->_duration * (((Float)1.0) - this->_position));
HXLINE( 131)		this->_animatePlayback = ::motion::Actuate_obj::update( ::Dynamic(new _hx_Closure_0(_gthis)),duration,::cpp::VirtualArray_obj::__new(1)->init(0,this->_position),::cpp::VirtualArray_obj::__new(1)->init(0,((Float)1.0)),null());
HXLINE( 134)		::motion::actuators::IGenericActuator_obj::ease(this->_animatePlayback,this->_ease);
HXLINE( 135)		::motion::actuators::IGenericActuator_obj::onComplete(this->_animatePlayback,this->animatePlayback_onComplete_dyn(),null());
            	}
...
void BaseEffectContext_obj::playReverse(){
            		HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::feathers::motion::effects::BaseEffectContext,_gthis) HXARGC(1)
            		void _hx_run(Float value){
            			HX_STACKFRAME(&_hx_pos_f314fcaef2849992_160_playReverse)
HXLINE( 160)			_gthis->set_position(value);
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_144_playReverse)
HXDLIN( 144)		 ::feathers::motion::effects::BaseEffectContext _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 145)		bool _hx_tmp;
HXDLIN( 145)		if (this->_playing) {
HXLINE( 145)			_hx_tmp = this->_reversed;
            		}
            		else {
...
HXLINE( 149)		if (::hx::IsNotNull( this->_animatePlayback )) {
HXLINE( 150)			::motion::Actuate_obj::stop(this->_animatePlayback,null(),false,false);
HXLINE( 151)			this->_animatePlayback = null();
            		}
HXLINE( 153)		this->_playing = true;
HXLINE( 154)		this->_reversed = true;
HXLINE( 156)		Float duration = (this->_duration * this->_position);
HXLINE( 159)		this->_animatePlayback = ::motion::Actuate_obj::update( ::Dynamic(new _hx_Closure_0(_gthis)),duration,::cpp::VirtualArray_obj::__new(1)->init(0,this->_position),::cpp::VirtualArray_obj::__new(1)->init(0,((Float)0.0)),null());
HXLINE( 162)		::motion::actuators::IGenericActuator_obj::ease(this->_animatePlayback,this->_ease);
HXLINE( 163)		::motion::actuators::IGenericActuator_obj::onComplete(this->_animatePlayback,this->animatePlayback_onComplete_dyn(),null());
            	}
...
void BaseEffectContext_obj::pause(){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_171_pause)
HXLINE( 172)		if (!(this->_playing)) {
HXLINE( 174)			return;
            		}
HXLINE( 176)		if (::hx::IsNotNull( this->_animatePlayback )) {
HXLINE( 177)			::motion::Actuate_obj::stop(this->_animatePlayback,null(),false,false);
HXLINE( 178)			this->_animatePlayback = null();
            		}
HXLINE( 180)		this->_playing = false;
            	}
...
void BaseEffectContext_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_191_stop)
HXLINE( 192)		this->pause();
HXLINE( 193)		this->cleanupEffect();
HXLINE( 194)		::feathers::events::FeathersEvent_obj::dispatch(::hx::ObjectPtr<OBJ_>(this),HX_("complete",b9,00,c8,7f),null(),null());
            	}
...
void BaseEffectContext_obj::toEnd(){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_205_toEnd)
HXLINE( 206)		this->pause();
HXLINE( 207)		this->_position = ((Float)1.0);
HXLINE( 208)		this->cleanupEffect();
HXLINE( 209)		::feathers::events::FeathersEvent_obj::dispatch(::hx::ObjectPtr<OBJ_>(this),HX_("complete",b9,00,c8,7f),null(),null());
            	}
...
void BaseEffectContext_obj::interrupt(){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_225_interrupt)
HXDLIN( 225)		this->toEnd();
            	}
...
void BaseEffectContext_obj::prepareEffect(){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_235_prepareEffect)
            	}
...
void BaseEffectContext_obj::updateEffect(){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_244_updateEffect)
            	}
...
void BaseEffectContext_obj::cleanupEffect(){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_253_cleanupEffect)
            	}
...
void BaseEffectContext_obj::animatePlayback_onComplete(){
            	HX_STACKFRAME(&_hx_pos_f314fcaef2849992_255_animatePlayback_onComplete)
HXLINE( 256)		this->_animatePlayback = null();
HXLINE( 257)		this->cleanupEffect();
HXLINE( 258)		::feathers::events::FeathersEvent_obj::dispatch(::hx::ObjectPtr<OBJ_>(this),HX_("complete",b9,00,c8,7f),null(),null());
            	}
