...
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_43_get_dispatcher,"feathers.motion.effects.EventToPositionEffectContext","get_dispatcher",0x37584ad8,"feathers.motion.effects.EventToPositionEffectContext.get_dispatcher","feathers/motion/effects/EventToPositionEffectContext.hx",43,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_46_set_dispatcher,"feathers.motion.effects.EventToPositionEffectContext","set_dispatcher",0x5778334c,"feathers.motion.effects.EventToPositionEffectContext.set_dispatcher","feathers/motion/effects/EventToPositionEffectContext.hx",46,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_66_get_eventType,"feathers.motion.effects.EventToPositionEffectContext","get_eventType",0x6fe06be3,"feathers.motion.effects.EventToPositionEffectContext.get_eventType","feathers/motion/effects/EventToPositionEffectContext.hx",66,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_69_set_eventType,"feathers.motion.effects.EventToPositionEffectContext","set_eventType",0xb4e64def,"feathers.motion.effects.EventToPositionEffectContext.set_eventType","feathers/motion/effects/EventToPositionEffectContext.hx",69,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_91_get_callback,"feathers.motion.effects.EventToPositionEffectContext","get_callback",0x24dabcb6,"feathers.motion.effects.EventToPositionEffectContext.get_callback","feathers/motion/effects/EventToPositionEffectContext.hx",91,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_94_set_callback,"feathers.motion.effects.EventToPositionEffectContext","set_callback",0x39d3e02a,"feathers.motion.effects.EventToPositionEffectContext.set_callback","feathers/motion/effects/EventToPositionEffectContext.hx",94,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_105_play,"feathers.motion.effects.EventToPositionEffectContext","play",0x089774dc,"feathers.motion.effects.EventToPositionEffectContext.play","feathers/motion/effects/EventToPositionEffectContext.hx",105,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_110_playReverse,"feathers.motion.effects.EventToPositionEffectContext","playReverse",0x33a67fa6,"feathers.motion.effects.EventToPositionEffectContext.playReverse","feathers/motion/effects/EventToPositionEffectContext.hx",110,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_115_pause,"feathers.motion.effects.EventToPositionEffectContext","pause",0x74b89b0e,"feathers.motion.effects.EventToPositionEffectContext.pause","feathers/motion/effects/EventToPositionEffectContext.hx",115,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_119_clearEvent,"feathers.motion.effects.EventToPositionEffectContext","clearEvent",0x62b86c35,"feathers.motion.effects.EventToPositionEffectContext.clearEvent","feathers/motion/effects/EventToPositionEffectContext.hx",119,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_126_updateEvent,"feathers.motion.effects.EventToPositionEffectContext","updateEvent",0x2fac1769,"feathers.motion.effects.EventToPositionEffectContext.updateEvent","feathers/motion/effects/EventToPositionEffectContext.hx",126,0x0420c0f7)
HX_LOCAL_STACK_FRAME(_hx_pos_d4abe8735fb984e8_133_eventToPositionEffectContext_dispatcher_eventHandler,"feathers.motion.effects.EventToPositionEffectContext","eventToPositionEffectContext_dispatcher_eventHandler",0x394e6091,"feathers.motion.effects.EventToPositionEffectContext.eventToPositionEffectContext_dispatcher_eventHandler","feathers/motion/effects/EventToPositionEffectContext.hx",133,0x0420c0f7)
namespace feathers{
namespace motion{
namespace effects{
...
::Dynamic EventToPositionEffectContext_obj::get_dispatcher(){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_43_get_dispatcher)
HXDLIN(  43)		return this->_dispatcher;
            	}
...
::Dynamic EventToPositionEffectContext_obj::set_dispatcher(::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_46_set_dispatcher)
HXLINE(  47)		if (::hx::IsInstanceEq( this->_dispatcher,value )) {
HXLINE(  48)			return this->_dispatcher;
            		}
HXLINE(  50)		this->clearEvent();
HXLINE(  51)		this->_dispatcher = value;
HXLINE(  52)		this->updateEvent();
HXLINE(  53)		return this->get_dispatcher();
            	}
...
::String EventToPositionEffectContext_obj::get_eventType(){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_66_get_eventType)
HXDLIN(  66)		return this->_eventType;
            	}
...
::String EventToPositionEffectContext_obj::set_eventType(::String value){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_69_set_eventType)
HXLINE(  70)		if ((this->_eventType == value)) {
HXLINE(  71)			return this->_eventType;
            		}
HXLINE(  73)		this->clearEvent();
HXLINE(  74)		this->_eventType = value;
HXLINE(  75)		this->updateEvent();
HXLINE(  76)		return this->_eventType;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(EventToPositionEffectContext_obj,set_eventType,return )
 ...
 ::Dynamic EventToPositionEffectContext_obj::get_callback(){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_91_get_callback)
HXDLIN(  91)		return this->_callback;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(EventToPositionEffectContext_obj,get_callback,return )
 ...
 ::Dynamic EventToPositionEffectContext_obj::set_callback( ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_94_set_callback)
HXLINE(  95)		if (::hx::IsEq( this->_callback,value )) {
HXLINE(  96)			return this->_callback;
            		}
HXLINE(  98)		this->_callback = value;
HXLINE(  99)		return this->_callback;
            	}
...
void EventToPositionEffectContext_obj::play(){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_105_play)
HXDLIN( 105)		this->_paused = false;
            	}


void EventToPositionEffectContext_obj::playReverse(){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_110_playReverse)
HXDLIN( 110)		this->_paused = false;
            	}


void EventToPositionEffectContext_obj::pause(){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_115_pause)
HXDLIN( 115)		this->_paused = true;
            	}


void EventToPositionEffectContext_obj::clearEvent(){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_119_clearEvent)
HXLINE( 120)		bool _hx_tmp;
HXDLIN( 120)		if (::hx::IsNotNull( this->_dispatcher )) {
HXLINE( 120)			_hx_tmp = ::hx::IsNull( this->_eventType );
            		}
            		else {
...
HXLINE( 123)		::openfl::events::IEventDispatcher_obj::removeEventListener(this->_dispatcher,this->_eventType,this->eventToPositionEffectContext_dispatcher_eventHandler_dyn(),null());
            	}
...
void EventToPositionEffectContext_obj::updateEvent(){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_126_updateEvent)
HXLINE( 127)		bool _hx_tmp;
HXDLIN( 127)		if (::hx::IsNotNull( this->_dispatcher )) {
HXLINE( 127)			_hx_tmp = ::hx::IsNull( this->_eventType );
            		}
            		else {
...
HXLINE( 130)		::openfl::events::IEventDispatcher_obj::addEventListener(this->_dispatcher,this->_eventType,this->eventToPositionEffectContext_dispatcher_eventHandler_dyn(),false,0,true);
            	}
...
void EventToPositionEffectContext_obj::eventToPositionEffectContext_dispatcher_eventHandler( ::openfl::events::Event event){
            	HX_STACKFRAME(&_hx_pos_d4abe8735fb984e8_133_eventToPositionEffectContext_dispatcher_eventHandler)
HXLINE( 134)		if (this->_paused) {
HXLINE( 135)			return;
            		}
HXLINE( 137)		this->set_position(( (Float)(this->_callback(event)) ));
            	}
