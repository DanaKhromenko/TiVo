...
HXLINE( 242)						 ::Dynamic target1 = this->target;
HXDLIN( 242)						 ::Dynamic value1 = false;
HXDLIN( 242)						if (::Reflect_obj::hasField(target1,HX_("visible",72,78,24,a3))) {
HXLINE( 242)							::Reflect_obj::setField(target1,HX_("visible",72,78,24,a3),value1);
            						}
            						else {
HXLINE( 242)							::Reflect_obj::setProperty(target1,HX_("visible",72,78,24,a3),value1);
            						}
            					}
