...
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_83_setUp,"feathers.motion.transitions.SlideTransitionBuilder","setUp",0x6d77f60e,"feathers.motion.transitions.SlideTransitionBuilder.setUp","feathers/motion/transitions/SlideTransitionBuilder.hx",83,0x878c96be)
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_92_setDown,"feathers.motion.transitions.SlideTransitionBuilder","setDown",0xa8af1ad5,"feathers.motion.transitions.SlideTransitionBuilder.setDown","feathers/motion/transitions/SlideTransitionBuilder.hx",92,0x878c96be)
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_101_setLeft,"feathers.motion.transitions.SlideTransitionBuilder","setLeft",0xadf12a7a,"feathers.motion.transitions.SlideTransitionBuilder.setLeft","feathers/motion/transitions/SlideTransitionBuilder.hx",101,0x878c96be)
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_110_setRight,"feathers.motion.transitions.SlideTransitionBuilder","setRight",0xfc210e09,"feathers.motion.transitions.SlideTransitionBuilder.setRight","feathers/motion/transitions/SlideTransitionBuilder.hx",110,0x878c96be)
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_118_setDuration,"feathers.motion.transitions.SlideTransitionBuilder","setDuration",0x061ce747,"feathers.motion.transitions.SlideTransitionBuilder.setDuration","feathers/motion/transitions/SlideTransitionBuilder.hx",118,0x878c96be)
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_128_setEase,"feathers.motion.transitions.SlideTransitionBuilder","setEase",0xa94dae61,"feathers.motion.transitions.SlideTransitionBuilder.setEase","feathers/motion/transitions/SlideTransitionBuilder.hx",128,0x878c96be)
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_139_setParallax,"feathers.motion.transitions.SlideTransitionBuilder","setParallax",0x6f857f4a,"feathers.motion.transitions.SlideTransitionBuilder.setParallax","feathers/motion/transitions/SlideTransitionBuilder.hx",139,0x878c96be)
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_153_setInterruptBehavior,"feathers.motion.transitions.SlideTransitionBuilder","setInterruptBehavior",0xf2013302,"feathers.motion.transitions.SlideTransitionBuilder.setInterruptBehavior","feathers/motion/transitions/SlideTransitionBuilder.hx",153,0x878c96be)
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_247_build,"feathers.motion.transitions.SlideTransitionBuilder","build",0xae333e9f,"feathers.motion.transitions.SlideTransitionBuilder.build","feathers/motion/transitions/SlideTransitionBuilder.hx",247,0x878c96be)
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_171_build,"feathers.motion.transitions.SlideTransitionBuilder","build",0xae333e9f,"feathers.motion.transitions.SlideTransitionBuilder.build","feathers/motion/transitions/SlideTransitionBuilder.hx",171,0x878c96be)
...
HX_LOCAL_STACK_FRAME(_hx_pos_83146237e6bb70f5_163_build,"feathers.motion.transitions.SlideTransitionBuilder","build",0xae333e9f,"feathers.motion.transitions.SlideTransitionBuilder.build","feathers/motion/transitions/SlideTransitionBuilder.hx",163,0x878c96be)
...
HXDLIN(  74)		this->_angle = ((angleRadians * ((Float)180.0)) / ::Math_obj::PI);
HXDLIN(  74)		return ::hx::ObjectPtr<OBJ_>(this);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(SlideTransitionBuilder_obj,setRadians,return )
 ...
 ::feathers::motion::transitions::SlideTransitionBuilder SlideTransitionBuilder_obj::setUp(){
            	HX_STACKFRAME(&_hx_pos_83146237e6bb70f5_83_setUp)
HXDLIN(  83)		this->_angle = ((Float)90.0);
HXDLIN(  83)		return ::hx::ObjectPtr<OBJ_>(this);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SlideTransitionBuilder_obj,setUp,return )
 ...
 ::feathers::motion::transitions::SlideTransitionBuilder SlideTransitionBuilder_obj::setDown(){
            	HX_STACKFRAME(&_hx_pos_83146237e6bb70f5_92_setDown)
HXDLIN(  92)		this->_angle = ((Float)270.0);
...
HX_DEFINE_DYNAMIC_FUNC0(SlideTransitionBuilder_obj,setDown,return )
 ...
 ::feathers::motion::transitions::SlideTransitionBuilder SlideTransitionBuilder_obj::setLeft(){
            	HX_STACKFRAME(&_hx_pos_83146237e6bb70f5_101_setLeft)
HXDLIN( 101)		this->_angle = ((Float)180.0);
...
HX_DEFINE_DYNAMIC_FUNC0(SlideTransitionBuilder_obj,setLeft,return )
 ...
 ::feathers::motion::transitions::SlideTransitionBuilder SlideTransitionBuilder_obj::setRight(){
            	HX_STACKFRAME(&_hx_pos_83146237e6bb70f5_110_setRight)
HXDLIN( 110)		this->_angle = ((Float)0.0);
HXDLIN( 110)		return ::hx::ObjectPtr<OBJ_>(this);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SlideTransitionBuilder_obj,setRight,return )
 ...
 ::feathers::motion::transitions::SlideTransitionBuilder SlideTransitionBuilder_obj::setDuration(Float duration){
            	HX_STACKFRAME(&_hx_pos_83146237e6bb70f5_118_setDuration)
HXLINE( 119)		this->_duration = duration;
...
HX_DEFINE_DYNAMIC_FUNC1(SlideTransitionBuilder_obj,setDuration,return )
 ...
 ::feathers::motion::transitions::SlideTransitionBuilder SlideTransitionBuilder_obj::setEase(::Dynamic ease){
            	HX_STACKFRAME(&_hx_pos_83146237e6bb70f5_128_setEase)
HXLINE( 129)		this->_ease = ease;
...
HX_DEFINE_DYNAMIC_FUNC1(SlideTransitionBuilder_obj,setEase,return )
 ...
 ::feathers::motion::transitions::SlideTransitionBuilder SlideTransitionBuilder_obj::setParallax(Float parallax){
            	HX_GC_STACKFRAME(&_hx_pos_83146237e6bb70f5_139_setParallax)
HXLINE( 140)		bool _hx_tmp;
HXDLIN( 140)		if (!((parallax < ((Float)0.0)))) {
HXLINE( 140)			_hx_tmp = (parallax > ((Float)1.0));
            		}
            		else {
HXLINE( 140)			_hx_tmp = true;
            		}
HXDLIN( 140)		if (_hx_tmp) {
HXLINE( 141)			HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__alloc( HX_CTX ,((HX_("Invalid parallax value: ",f7,65,c7,79) + parallax) + HX_(". Expected a value between 0.0 and 1.0.",4e,94,8d,2f))));
            		}
HXLINE( 143)		this->_parallax = parallax;
...
HX_DEFINE_DYNAMIC_FUNC1(SlideTransitionBuilder_obj,setParallax,return )
 ...
 ::feathers::motion::transitions::SlideTransitionBuilder SlideTransitionBuilder_obj::setInterruptBehavior( ::feathers::motion::effects::EffectInterruptBehavior interruptBehavior){
            	HX_STACKFRAME(&_hx_pos_83146237e6bb70f5_153_setInterruptBehavior)
HXLINE( 154)		this->_interruptBehavior = interruptBehavior;
HXLINE( 155)		return ::hx::ObjectPtr<OBJ_>(this);
            	}
 ...
 ::Dynamic SlideTransitionBuilder_obj::build(){
            		...
            		::Dynamic _hx_run( ::openfl::display::DisplayObject oldView, ::openfl::display::DisplayObject newView){
            			...
            			void _hx_run(Float x,Float y){
            				HX_GC_STACKFRAME(&_hx_pos_83146237e6bb70f5_247_build)
HXLINE( 248)				if (::hx::IsNotNull( oldView )) {
HXLINE( 249)					oldView->set_x((x * _gthis->_parallax));
HXLINE( 250)					oldView->set_y((y * _gthis->_parallax));
            				}
HXLINE( 252)				if (::hx::IsNotNull( newView )) {
HXLINE( 253)					newView->set_x((x - endX->__get(0)));
HXLINE( 254)					newView->set_y((y - endY->__get(0)));
            				}
            			}
            			HX_END_LOCAL_FUNC2((void))

            			HX_GC_STACKFRAME(&_hx_pos_83146237e6bb70f5_171_build)
HXLINE( 172)			bool _hx_tmp;
HXDLIN( 172)			if (::hx::IsNull( oldView )) {
HXLINE( 172)				_hx_tmp = ::hx::IsNull( newView );
            			}
            			else {
HXLINE( 172)				_hx_tmp = false;
            			}
HXDLIN( 172)			if (_hx_tmp) {
HXLINE( 173)				HX_STACK_DO_THROW( ::openfl::errors::ArgumentError_obj::__alloc( HX_CTX ,::feathers::motion::transitions::SlideTransitionBuilder_obj::VIEW_REQUIRED_ERROR));
            			}
HXLINE( 175)			 ::openfl::display::DisplayObjectContainer parent = null();
HXLINE( 176)			Float width = ((Float)0.0);
HXLINE( 177)			Float height = ((Float)0.0);
HXLINE( 178)			if (::hx::IsNotNull( oldView )) {
HXLINE( 179)				parent = oldView->parent;
HXLINE( 180)				width = oldView->get_width();
HXLINE( 181)				height = oldView->get_height();
            			}
HXLINE( 183)			if (::hx::IsNotNull( newView )) {
HXLINE( 184)				parent = newView->parent;
HXLINE( 185)				width = ::Math_obj::max(width,newView->get_width());
HXLINE( 186)				height = ::Math_obj::max(height,newView->get_height());
            			}
HXLINE( 188)			::Array< Float > endX = ::Array_obj< Float >::fromData( _hx_array_data_b91fa91f_13,1);
HXLINE( 189)			::Array< Float > endY = ::Array_obj< Float >::fromData( _hx_array_data_b91fa91f_14,1);
HXLINE( 190)			bool _hx_tmp1;
HXDLIN( 190)			if ((angle->__get(0) >= ((Float)0.0))) {
HXLINE( 190)				_hx_tmp1 = (angle->__get(0) < ((Float)45.0));
            			}
            			else {
HXLINE( 190)				_hx_tmp1 = false;
            			}
HXDLIN( 190)			if (_hx_tmp1) {
HXLINE( 192)				endX[0] = width;
HXLINE( 195)				Float hy = (width / ::Math_obj::cos(((angle->__get(0) * ::Math_obj::PI) / ((Float)180.0))));
HXLINE( 196)				endY[0] = -(::Math_obj::sqrt(((hy * hy) - (width * width))));
            			}
            			else {
HXLINE( 197)				bool _hx_tmp2;
HXDLIN( 197)				if ((angle->__get(0) >= ((Float)45.0))) {
HXLINE( 197)					_hx_tmp2 = (angle->__get(0) < ((Float)90.0));
            				}
            				else {
HXLINE( 197)					_hx_tmp2 = false;
            				}
HXDLIN( 197)				if (_hx_tmp2) {
HXLINE( 199)					endY[0] = -(height);
HXLINE( 202)					Float hy1 = (height / ::Math_obj::sin(((angle->__get(0) * ::Math_obj::PI) / ((Float)180.0))));
HXLINE( 203)					endX[0] = ::Math_obj::sqrt(((hy1 * hy1) - (height * height)));
            				}
            				else {
HXLINE( 204)					bool _hx_tmp3;
HXDLIN( 204)					if ((angle->__get(0) >= ((Float)90.0))) {
HXLINE( 204)						_hx_tmp3 = (angle->__get(0) < ((Float)135.0));
            					}
            					else {
HXLINE( 204)						_hx_tmp3 = false;
            					}
HXDLIN( 204)					if (_hx_tmp3) {
HXLINE( 206)						endY[0] = -(height);
HXLINE( 207)						Float hy2 = (height / ::Math_obj::cos((((angle->__get(0) - ((Float)90.0)) * ::Math_obj::PI) / ((Float)180.0))));
HXLINE( 208)						endX[0] = -(::Math_obj::sqrt(((hy2 * hy2) - (height * height))));
            					}
            					else {
HXLINE( 209)						bool _hx_tmp4;
HXDLIN( 209)						if ((angle->__get(0) >= ((Float)135.0))) {
HXLINE( 209)							_hx_tmp4 = (angle->__get(0) < ((Float)180.0));
            						}
            						else {
HXLINE( 209)							_hx_tmp4 = false;
            						}
HXDLIN( 209)						if (_hx_tmp4) {
HXLINE( 211)							endX[0] = -(width);
HXLINE( 212)							Float hy3 = (width / ::Math_obj::sin((((angle->__get(0) - ((Float)90.0)) * ::Math_obj::PI) / ((Float)180.0))));
HXLINE( 213)							endY[0] = -(::Math_obj::sqrt(((hy3 * hy3) - (width * width))));
            						}
            						else {
HXLINE( 214)							bool _hx_tmp5;
HXDLIN( 214)							if ((angle->__get(0) >= ((Float)180.0))) {
HXLINE( 214)								_hx_tmp5 = (angle->__get(0) < ((Float)225.0));
            							}
            							else {
...
HXLINE( 217)								Float hy4 = (width / ::Math_obj::cos((((angle->__get(0) - ((Float)180.0)) * ::Math_obj::PI) / ((Float)180.0))));
HXLINE( 218)								endY[0] = ::Math_obj::sqrt(((hy4 * hy4) - (width * width)));
            							}
            							else {
HXLINE( 219)								bool _hx_tmp6;
HXDLIN( 219)								if ((angle->__get(0) >= ((Float)225.0))) {
HXLINE( 219)									_hx_tmp6 = (angle->__get(0) < ((Float)270.0));
            								}
            								else {
HXLINE( 219)									_hx_tmp6 = false;
            								}
HXDLIN( 219)								if (_hx_tmp6) {
HXLINE( 221)									endY[0] = height;
HXLINE( 222)									Float hy5 = (height / ::Math_obj::sin((((angle->__get(0) - ((Float)180.0)) * ::Math_obj::PI) / ((Float)180.0))));
HXLINE( 223)									endX[0] = -(::Math_obj::sqrt(((hy5 * hy5) - (height * height))));
            								}
            								else {
HXLINE( 224)									bool _hx_tmp7;
HXDLIN( 224)									if ((angle->__get(0) >= ((Float)270.0))) {
HXLINE( 224)										_hx_tmp7 = (angle->__get(0) < ((Float)315.0));
            									}
            									else {
...
HXLINE( 227)										Float hy6 = (height / ::Math_obj::cos((((angle->__get(0) - ((Float)270.0)) * ::Math_obj::PI) / ((Float)180.0))));
HXLINE( 228)										endX[0] = ::Math_obj::sqrt(((hy6 * hy6) - (height * height)));
            									}
            									else {
HXLINE( 231)										endX[0] = width;
HXLINE( 232)										Float hy7 = (width / ::Math_obj::sin((((angle->__get(0) - ((Float)270.0)) * ::Math_obj::PI) / ((Float)180.0))));
HXLINE( 233)										endY[0] = ::Math_obj::sqrt(((hy7 * hy7) - (width * width)));
            									}
            								}
            							}
            						}
...
HXLINE( 235)			if (::hx::IsNotNull( newView )) {
HXLINE( 236)				newView->set_x(-(endX->__get(0)));
HXLINE( 237)				newView->set_y(-(endY->__get(0)));
            			}
HXLINE( 239)			bool _hx_tmp8;
HXDLIN( 239)			bool _hx_tmp9;
HXDLIN( 239)			if (::hx::IsNotNull( parent )) {
HXLINE( 239)				_hx_tmp9 = ::hx::IsNotNull( oldView );
            			}
            			else {
HXLINE( 239)				_hx_tmp9 = false;
            			}
HXDLIN( 239)			if (_hx_tmp9) {
HXLINE( 239)				_hx_tmp8 = ::hx::IsNotNull( newView );
            			}
            			else {
HXLINE( 239)				_hx_tmp8 = false;
            			}
HXDLIN( 239)			if (_hx_tmp8) {
HXLINE( 240)				int oldViewIndex = parent->getChildIndex(oldView);
HXLINE( 241)				int newViewIndex = parent->getChildIndex(newView);
HXLINE( 242)				if ((oldViewIndex > newViewIndex)) {
HXLINE( 244)					parent->swapChildren(oldView,newView);
            				}
            			}
HXLINE( 247)			::Dynamic actuator = ::feathers::motion::effects::actuate::ActuateForEffects_obj::update( ::Dynamic(new _hx_Closure_0(_gthis,newView,endY,endX,oldView)),duration,::cpp::VirtualArray_obj::__new(2)->init(0,((Float)0.0))->init(1,((Float)0.0)),::cpp::VirtualArray_obj::__new(2)->init(0,endX->__get(0))->init(1,endY->__get(0)),null());
HXLINE( 257)			if (::hx::IsNotNull( ease )) {
HXLINE( 258)				::motion::actuators::IGenericActuator_obj::ease(actuator,ease);
            			}
HXLINE( 260)			::motion::Actuate_obj::pause(actuator);
HXLINE( 261)			return  ::feathers::motion::effects::actuate::ActuateEffectContext_obj::__alloc( HX_CTX ,null(),actuator,interruptBehavior);
            		}
            		HX_END_LOCAL_FUNC2(return)

            	HX_STACKFRAME(&_hx_pos_83146237e6bb70f5_163_build)
HXDLIN( 163)		 ::feathers::motion::transitions::SlideTransitionBuilder _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 164)		::Array< Float > angle = ::Array_obj< Float >::__new(1)->init(0,::hx::Mod(this->_angle,((Float)360.0)));
HXLINE( 165)		if ((angle->__get(0) < ((Float)0.0))) {
HXLINE( 166)			::Array< Float > angle1 = angle;
HXDLIN( 166)			int _hx_tmp = 0;
HXDLIN( 166)			angle1[_hx_tmp] = (angle1->__get(_hx_tmp) + ((Float)360.0));
            		}
HXLINE( 168)		Float duration = this->_duration;
HXLINE( 169)		::Dynamic ease = this->_ease;
HXLINE( 170)		 ::feathers::motion::effects::EffectInterruptBehavior interruptBehavior = this->_interruptBehavior;
HXLINE( 171)		return  ::Dynamic(new _hx_Closure_1(duration,_gthis,angle,interruptBehavior,ease));
            	}
