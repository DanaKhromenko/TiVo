...
HXLINE( 354)					this->get_graphics()->lineStyle(thickness,color,alpha,pixelHinting,scaleMode,caps,joints,miterLimit);
            			...
            			break;
            			case (int)1: {
HXLINE( 377)				Float thickness1 = lineStyle->_hx_getFloat(0);
...
HXLINE( 385)					this->get_graphics()->lineStyle(thickness1,null(),null(),null(),null(),null(),null(),null());
HXLINE( 386)					this->get_graphics()->lineBitmapStyle(bitmapData,matrix,repeat,smooth);
            				}
            			}
            			break;
            			case (int)2: {
HXLINE( 356)				Float thickness2 = lineStyle->_hx_getFloat(0);
...
HXLINE( 371)					Float matrix1 = this->getDefaultGradientMatrixWidth();
HXDLIN( 371)					Float matrix2 = this->getDefaultGradientMatrixHeight();
HXDLIN( 371)					Float matrix3 = this->getDefaultGradientMatrixRadians();
HXLINE( 372)					Float matrix4 = this->getDefaultGradientMatrixTx();
HXLINE( 371)					 ::openfl::geom::Matrix matrix5 = ( ( ::openfl::geom::Matrix)(callback(matrix1,matrix2,matrix3,matrix4,this->getDefaultGradientMatrixTy())) );
HXLINE( 373)					this->get_graphics()->lineStyle(thickness2,null(),null(),null(),null(),null(),null(),null());
HXLINE( 374)					this->get_graphics()->lineGradientStyle(type,colors,alphas,ratios,matrix5,spreadMethod,interpolationMethod,focalPointRatio);
            				}
            			}
            			break;
            			case (int)3: {
...
HXLINE( 423)					Float matrix1 = this->getDefaultGradientMatrixWidth();
HXDLIN( 423)					Float matrix2 = this->getDefaultGradientMatrixHeight();
HXDLIN( 423)					Float matrix3 = this->getDefaultGradientMatrixRadians();
HXLINE( 424)					Float matrix4 = this->getDefaultGradientMatrixTx();
HXLINE( 423)					 ::openfl::geom::Matrix matrix5 = ( ( ::openfl::geom::Matrix)(callback(matrix1,matrix2,matrix3,matrix4,this->getDefaultGradientMatrixTy())) );
HXLINE( 425)					this->get_graphics()->beginGradientFill(type,colors,alphas,ratios,matrix5,spreadMethod,interpolationMethod,focalPointRatio);
            				}
            			}
            			break;
            			case (int)3: {
...
HXLINE( 448)				return ( (Float)(thickness) );
            			...
            			break;
            			case (int)2: {
HXLINE( 450)				 ::Dynamic _g7 = lineStyle->_hx_getObject(5);
HXDLIN( 450)				 ::Dynamic _g8 = lineStyle->_hx_getObject(6);
HXDLIN( 450)				 ::Dynamic _g9 = lineStyle->_hx_getObject(7);
HXDLIN( 450)				 ::Dynamic _g10 = lineStyle->_hx_getObject(8);
HXDLIN( 450)				Float thickness1 = lineStyle->_hx_getFloat(0);
