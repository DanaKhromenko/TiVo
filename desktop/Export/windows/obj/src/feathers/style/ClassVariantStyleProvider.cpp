...
HX_LOCAL_STACK_FRAME(_hx_pos_7908ae37b342d1d1_116_getStyleFunction,"feathers.style.ClassVariantStyleProvider","getStyleFunction",0x16496ce7,"feathers.style.ClassVariantStyleProvider.getStyleFunction","feathers/style/ClassVariantStyleProvider.hx",116,0x134bebc6)
HX_LOCAL_STACK_FRAME(_hx_pos_7908ae37b342d1d1_124_applyStyles,"feathers.style.ClassVariantStyleProvider","applyStyles",0x9255ccbc,"feathers.style.ClassVariantStyleProvider.applyStyles","feathers/style/ClassVariantStyleProvider.hx",124,0x134bebc6)
HX_LOCAL_STACK_FRAME(_hx_pos_7908ae37b342d1d1_137_getStyleContext,"feathers.style.ClassVariantStyleProvider","getStyleContext",0x64184300,"feathers.style.ClassVariantStyleProvider.getStyleContext","feathers/style/ClassVariantStyleProvider.hx",137,0x134bebc6)
HX_LOCAL_STACK_FRAME(_hx_pos_7908ae37b342d1d1_149_getVariant,"feathers.style.ClassVariantStyleProvider","getVariant",0x4b8cb583,"feathers.style.ClassVariantStyleProvider.getVariant","feathers/style/ClassVariantStyleProvider.hx",149,0x134bebc6)
HX_LOCAL_STACK_FRAME(_hx_pos_7908ae37b342d1d1_158_getStyleFunctionInternal,"feathers.style.ClassVariantStyleProvider","getStyleFunctionInternal",0x39934f44,"feathers.style.ClassVariantStyleProvider.getStyleFunctionInternal","feathers/style/ClassVariantStyleProvider.hx",158,0x134bebc6)
namespace feathers{
namespace style{
...
HX_DEFINE_DYNAMIC_FUNC3(ClassVariantStyleProvider_obj,setStyleFunction,(void))
 ...
 ::Dynamic ClassVariantStyleProvider_obj::getStyleFunction(::hx::Class type,::String variant){
            	HX_STACKFRAME(&_hx_pos_7908ae37b342d1d1_116_getStyleFunction)
HXDLIN( 116)		return this->getStyleFunctionInternal(type,variant,true);
            	}
...
void ClassVariantStyleProvider_obj::applyStyles(::Dynamic target){
            	HX_STACKFRAME(&_hx_pos_7908ae37b342d1d1_124_applyStyles)
HXLINE( 125)		if (::hx::IsNull( this->styleTargets )) {
HXLINE( 126)			return;
            		}
HXLINE( 128)		::hx::Class styleContext = this->getStyleContext(target);
HXLINE( 129)		::String variant = this->getVariant(target);
HXLINE( 130)		 ::Dynamic callback = this->getStyleFunctionInternal(styleContext,variant,false);
HXLINE( 131)		if (::hx::IsNull( callback )) {
HXLINE( 132)			return;
            		}
HXLINE( 134)		callback(target);
            	}
...
::hx::Class ClassVariantStyleProvider_obj::getStyleContext(::Dynamic target){
            	HX_STACKFRAME(&_hx_pos_7908ae37b342d1d1_137_getStyleContext)
HXLINE( 138)		::hx::Class styleContext = null();
HXLINE( 139)		if (::Std_obj::isOfType(target,::hx::ClassOf< ::feathers::style::IVariantStyleObject >())) {
HXLINE( 140)			::Dynamic variantObject = target;
HXLINE( 141)			styleContext = ::feathers::style::IVariantStyleObject_obj::get_styleContext(variantObject);
            		}
HXLINE( 143)		if (::hx::IsNull( styleContext )) {
HXLINE( 144)			styleContext = ::Type_obj::getClass(target);
            		}
HXLINE( 146)		return styleContext;
            	}
...
::String ClassVariantStyleProvider_obj::getVariant(::Dynamic target){
            	HX_STACKFRAME(&_hx_pos_7908ae37b342d1d1_149_getVariant)
HXLINE( 150)		::String variant = null();
HXLINE( 151)		if (::Std_obj::isOfType(target,::hx::ClassOf< ::feathers::style::IVariantStyleObject >())) {
HXLINE( 152)			::Dynamic variantObject = target;
HXLINE( 153)			variant = ::feathers::style::IVariantStyleObject_obj::get_variant(variantObject);
            		}
HXLINE( 155)		return variant;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ClassVariantStyleProvider_obj,getVariant,return )
 ...
 ::Dynamic ClassVariantStyleProvider_obj::getStyleFunctionInternal(::hx::Class type,::String variant,bool strict){
            	HX_STACKFRAME(&_hx_pos_7908ae37b342d1d1_158_getStyleFunctionInternal)
HXLINE( 159)		if (::hx::IsNull( this->styleTargets )) {
HXLINE( 160)			return null();
            		}
HXLINE( 162)		::String typeName = ::Type_obj::getClassName(type);
HXLINE( 163)		 ::feathers::style::_ClassVariantStyleProvider::StyleTarget styleTarget;
HXDLIN( 163)		if (::hx::IsNull( variant )) {
HXLINE( 163)			styleTarget = ::feathers::style::_ClassVariantStyleProvider::StyleTarget_obj::Class(typeName);
            		}
            		else {
HXLINE( 163)			styleTarget = ::feathers::style::_ClassVariantStyleProvider::StyleTarget_obj::ClassAndVariant(typeName,variant);
            		}
HXLINE( 164)		 ::Dynamic result = this->styleTargets->get(styleTarget);
HXLINE( 165)		bool _hx_tmp;
HXDLIN( 165)		if (::hx::IsNull( result )) {
HXLINE( 165)			_hx_tmp = strict;
            		}
            		else {
...
HXLINE( 169)		return this->styleTargets->get(::feathers::style::_ClassVariantStyleProvider::StyleTarget_obj::Class(typeName));
            	}
