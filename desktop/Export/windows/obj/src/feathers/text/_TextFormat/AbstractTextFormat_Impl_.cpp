...
HX_LOCAL_STACK_FRAME(_hx_pos_20002029157e0b08_465_fromSimpleTextFormat,"feathers.text._TextFormat.AbstractTextFormat_Impl_","fromSimpleTextFormat",0x75dab11a,"feathers.text._TextFormat.AbstractTextFormat_Impl_.fromSimpleTextFormat","feathers/text/TextFormat.hx",465,0x45997e37)
HX_LOCAL_STACK_FRAME(_hx_pos_20002029157e0b08_482_toSimpleTextFormat,"feathers.text._TextFormat.AbstractTextFormat_Impl_","toSimpleTextFormat",0xba6950ab,"feathers.text._TextFormat.AbstractTextFormat_Impl_.toSimpleTextFormat","feathers/text/TextFormat.hx",482,0x45997e37)
namespace feathers{
namespace text{
...
bool AbstractTextFormat_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::feathers::text::TextFormat AbstractTextFormat_Impl__obj::fromSimpleTextFormat( ::openfl::text::TextFormat textFormat){
            	HX_GC_STACKFRAME(&_hx_pos_20002029157e0b08_465_fromSimpleTextFormat)
HXLINE( 466)		 ::feathers::text::TextFormat clone =  ::feathers::text::TextFormat_obj::__alloc( HX_CTX ,textFormat->font,textFormat->size,textFormat->color,textFormat->bold,textFormat->italic,textFormat->underline,textFormat->url,textFormat->target,textFormat->align,textFormat->leftMargin,textFormat->rightMargin,textFormat->indent,textFormat->leading);
HXLINE( 468)		clone->set_blockIndent(textFormat->blockIndent);
HXLINE( 469)		clone->set_bullet(textFormat->bullet);
HXLINE( 470)		clone->set_kerning(textFormat->kerning);
HXLINE( 471)		clone->set_letterSpacing(textFormat->letterSpacing);
HXLINE( 472)		clone->set_tabStops(textFormat->tabStops);
HXLINE( 473)		return clone;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(AbstractTextFormat_Impl__obj,fromSimpleTextFormat,return )
 ...
 ::openfl::text::TextFormat AbstractTextFormat_Impl__obj::toSimpleTextFormat( ::feathers::text::TextFormat this1){
            	HX_STACKFRAME(&_hx_pos_20002029157e0b08_482_toSimpleTextFormat)
HXDLIN( 482)		return this1->toSimpleTextFormat();
            	}
