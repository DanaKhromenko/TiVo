...
HX_LOCAL_STACK_FRAME(_hx_pos_0e8cfe2d622940b4_63_initialize,"feathers.themes.steel.components.SteelLabelStyles","initialize",0x480f2ca4,"feathers.themes.steel.components.SteelLabelStyles.initialize","feathers/themes/steel/components/SteelLabelStyles.hx",63,0x3c40fae4)
namespace feathers{
namespace themes{
namespace steel{
...
HXLINE(  62)		if (::hx::IsNull( styleProvider->getStyleFunction(::hx::ClassOf< ::feathers::controls::Label >(),::feathers::controls::Label_obj::VARIANT_DANGER) )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_3,::Array< ::Dynamic>,theme1) HXARGC(1)
            			void _hx_run( ::feathers::controls::Label label){
            				HX_STACKFRAME(&_hx_pos_0e8cfe2d622940b4_63_initialize)
HXLINE(  64)				if (::hx::IsNull( label->get_textFormat() )) {
HXLINE(  65)					label->set_textFormat(theme1->__get(0).StaticCast<  ::feathers::themes::steel::BaseSteelTheme >()->getDangerTextFormat(null()));
            				}
HXLINE(  67)				if (::hx::IsNull( label->get_disabledTextFormat() )) {
HXLINE(  68)					label->set_disabledTextFormat(theme1->__get(0).StaticCast<  ::feathers::themes::steel::BaseSteelTheme >()->getDisabledTextFormat(null()));
            				}
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE(  63)			styleProvider->setStyleFunction(::hx::ClassOf< ::feathers::controls::Label >(),::feathers::controls::Label_obj::VARIANT_DANGER, ::Dynamic(new _hx_Closure_3(theme1)));
            		}
            	}
