...
HXDLIN( 147)		if (::Std_obj::isOfType(target,::hx::ClassOf< ::motion::actuators::IGenericActuator >())) {
...
HXDLIN( 248)		if (::Std_obj::isOfType(target,::hx::ClassOf< ::motion::actuators::IGenericActuator >())) {
...
HXLINE( 312)			if (::Std_obj::isOfType(target,::hx::ClassOf< ::motion::actuators::IGenericActuator >())) {
...
HXLINE( 323)					if (::Std_obj::isOfType(properties,::hx::ClassOf< ::String >())) {
...
HXLINE( 329)						if (::Std_obj::isOfType(properties,::hx::ArrayBase::__mClass)) {
