...
HX_DEFINE_STACK_FRAME(_hx_pos_eed411078e5a761e_279_new,"motion._MotionPath.BezierPath","new",0x603d1d62,"motion._MotionPath.BezierPath.new","motion/MotionPath.hx",279,0x95e57daa)
HX_LOCAL_STACK_FRAME(_hx_pos_eed411078e5a761e_288_calculate,"motion._MotionPath.BezierPath","calculate",0x01f68fe8,"motion._MotionPath.BezierPath.calculate","motion/MotionPath.hx",288,0x95e57daa)
HX_LOCAL_STACK_FRAME(_hx_pos_eed411078e5a761e_339_get_start,"motion._MotionPath.BezierPath","get_start",0xc440cb3b,"motion._MotionPath.BezierPath.get_start","motion/MotionPath.hx",339,0x95e57daa)
HX_LOCAL_STACK_FRAME(_hx_pos_eed411078e5a761e_346_set_start,"motion._MotionPath.BezierPath","set_start",0xa791b747,"motion._MotionPath.BezierPath.set_start","motion/MotionPath.hx",346,0x95e57daa)
HX_LOCAL_STACK_FRAME(_hx_pos_eed411078e5a761e_353_get_end,"motion._MotionPath.BezierPath","get_end",0x30a2c274,"motion._MotionPath.BezierPath.get_end","motion/MotionPath.hx",353,0x95e57daa)
namespace motion{
namespace _MotionPath{

void BezierPath_obj::__construct(Float end,::Array< Float > control,Float strength){
            	HX_STACKFRAME(&_hx_pos_eed411078e5a761e_279_new)
HXLINE( 281)		this->_end = end;
HXLINE( 282)		this->control = control;
HXLINE( 283)		this->strength = strength;
            	}
...
Float BezierPath_obj::calculate(Float k){
            	HX_STACKFRAME(&_hx_pos_eed411078e5a761e_288_calculate)
HXLINE( 292)		Float l = (( (Float)(1) ) - k);
HXLINE( 294)		switch((int)(this->control->length)){
            			case (int)0: {
HXLINE( 298)				return ((l * this->_start) + (k * this->_end));
            			}
            			break;
            			case (int)1: {
HXLINE( 302)				return ((((l * l) * this->_start) + (((( (Float)(2) ) * l) * k) * this->control->__get(0))) + ((k * k) * this->_end));
            			}
            			break;
            			case (int)2: {
HXLINE( 306)				return ((((((l * l) * l) * this->_start) + ((((( (Float)(3) ) * l) * l) * k) * this->control->__get(0))) + ((((( (Float)(3) ) * l) * k) * k) * this->control->__get(1))) + (((k * k) * k) * this->_end));
            			}
            			break;
            			default:{
HXLINE( 313)				if ((l < ((Float)1e-7))) {
HXLINE( 314)					return this->_end;
            				}
HXLINE( 316)				Float r = (k / l);
HXLINE( 318)				int n = (this->control->length + 1);
HXLINE( 319)				Float coeff = ::Math_obj::pow(l,( (Float)(n) ));
HXLINE( 320)				Float res = (coeff * this->_start);
HXLINE( 322)				{
HXLINE( 322)					int _g = 1;
...
HXLINE( 323)						coeff = (coeff * ((r * ( (Float)(((n + 1) - i)) )) / ( (Float)(i) )));
HXLINE( 324)						res = (res + (coeff * this->control->__get((i - 1))));
            					}
            				}
HXLINE( 326)				coeff = (coeff * (r / ( (Float)(n) )));
HXLINE( 327)				return (res + (coeff * this->_end));
            			}
            		}
HXLINE( 294)		return ((Float)0.);
            	}
...
Float BezierPath_obj::get_start(){
            	HX_STACKFRAME(&_hx_pos_eed411078e5a761e_339_get_start)
HXDLIN( 339)		return this->_start;
            	}
...
Float BezierPath_obj::set_start(Float value){
            	HX_STACKFRAME(&_hx_pos_eed411078e5a761e_346_set_start)
HXDLIN( 346)		return (this->_start = value);
            	}
...
Float BezierPath_obj::get_end(){
            	HX_STACKFRAME(&_hx_pos_eed411078e5a761e_353_get_end)
HXDLIN( 353)		return this->_end;
            	}
