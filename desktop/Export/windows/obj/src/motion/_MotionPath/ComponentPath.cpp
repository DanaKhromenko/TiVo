...
HX_LOCAL_STACK_FRAME(_hx_pos_544a6c473e370053_215_get_start,"motion._MotionPath.ComponentPath","get_start",0x179627c1,"motion._MotionPath.ComponentPath.get_start","motion/MotionPath.hx",215,0x95e57daa)
HX_LOCAL_STACK_FRAME(_hx_pos_544a6c473e370053_222_set_start,"motion._MotionPath.ComponentPath","set_start",0xfae713cd,"motion._MotionPath.ComponentPath.set_start","motion/MotionPath.hx",222,0x95e57daa)
HX_LOCAL_STACK_FRAME(_hx_pos_544a6c473e370053_237_get_end,"motion._MotionPath.ComponentPath","get_end",0x4ed1d17a,"motion._MotionPath.ComponentPath.get_end","motion/MotionPath.hx",237,0x95e57daa)
namespace motion{
...
HXDLIN( 187)					_g = (_g + 1);
HXLINE( 190)					if (((ratio - ( (Float)(path->__Field(HX_("strength",81,d2,8e,8e),::hx::paccDynamic)) )) > ((Float)1e-7))) {
HXLINE( 192)						ratio = (ratio - ( (Float)(path->__Field(HX_("strength",81,d2,8e,8e),::hx::paccDynamic)) ));
            					}
            					else {
HXLINE( 196)						return ::motion::IComponentPath_obj::calculate(path,(ratio / ( (Float)(path->__Field(HX_("strength",81,d2,8e,8e),::hx::paccDynamic)) )));
            					}
            				}
            			}
            		}
...
Float ComponentPath_obj::get_start(){
            	HX_STACKFRAME(&_hx_pos_544a6c473e370053_215_get_start)
HXDLIN( 215)		if ((this->paths->length > 0)) {
HXDLIN( 215)			return ::motion::IComponentPath_obj::get_start(this->paths->__get(0));
            		}
            		else {
HXDLIN( 215)			return ( (Float)(0) );
            		}
HXDLIN( 215)		return ((Float)0.);
            	}
...
Float ComponentPath_obj::set_start(Float value){
            	HX_STACKFRAME(&_hx_pos_544a6c473e370053_222_set_start)
HXDLIN( 222)		if ((this->paths->length > 0)) {
HXLINE( 224)			return ::motion::IComponentPath_obj::set_start(this->paths->__get(0),value);
            		}
            		else {
HXLINE( 228)			return ( (Float)(0) );
            		}
...
Float ComponentPath_obj::get_end(){
            	HX_STACKFRAME(&_hx_pos_544a6c473e370053_237_get_end)
HXDLIN( 237)		if ((this->paths->length > 0)) {
HXLINE( 239)			::Dynamic path = this->paths->__get((this->paths->length - 1));
HXLINE( 240)			return ::motion::IComponentPath_obj::get_end(path);
            		}
            		else {
HXLINE( 244)			return this->get_start();
            		}
