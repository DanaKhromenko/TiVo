...
HX_DEFINE_STACK_FRAME(_hx_pos_1630a997d07a1e21_483_new,"motion._MotionPath.RotationPath","new",0xce3c6c81,"motion._MotionPath.RotationPath.new","motion/MotionPath.hx",483,0x95e57daa)
HX_LOCAL_STACK_FRAME(_hx_pos_1630a997d07a1e21_509_calculate,"motion._MotionPath.RotationPath","calculate",0xa1f48047,"motion._MotionPath.RotationPath.calculate","motion/MotionPath.hx",509,0x95e57daa)
HX_LOCAL_STACK_FRAME(_hx_pos_1630a997d07a1e21_529_get_start,"motion._MotionPath.RotationPath","get_start",0x643ebb9a,"motion._MotionPath.RotationPath.get_start","motion/MotionPath.hx",529,0x95e57daa)
HX_LOCAL_STACK_FRAME(_hx_pos_1630a997d07a1e21_536_set_start,"motion._MotionPath.RotationPath","set_start",0x478fa7a6,"motion._MotionPath.RotationPath.set_start","motion/MotionPath.hx",536,0x95e57daa)
HX_LOCAL_STACK_FRAME(_hx_pos_1630a997d07a1e21_543_get_end,"motion._MotionPath.RotationPath","get_end",0x8b618d13,"motion._MotionPath.RotationPath.get_end","motion/MotionPath.hx",543,0x95e57daa)
namespace motion{
...
void RotationPath_obj::__construct( ::motion::_MotionPath::ComponentPath x, ::motion::_MotionPath::ComponentPath y){
            	HX_STACKFRAME(&_hx_pos_1630a997d07a1e21_483_new)
HXLINE( 492)		this->step = ((Float)0.01);
HXLINE( 499)		this->_x = x;
HXLINE( 500)		this->_y = y;
HXLINE( 502)		this->offset = ( (Float)(0) );
HXLINE( 504)		this->set_start(this->calculate(((Float)0.0)));
            	}
...
Float RotationPath_obj::calculate(Float k){
            	HX_STACKFRAME(&_hx_pos_1630a997d07a1e21_509_calculate)
HXLINE( 511)		Float dX = this->_x->calculate(k);
HXDLIN( 511)		Float dX1 = (dX - this->_x->calculate((k + this->step)));
HXLINE( 512)		Float dY = this->_y->calculate(k);
HXDLIN( 512)		Float dY1 = (dY - this->_y->calculate((k + this->step)));
HXLINE( 514)		Float angle = (::Math_obj::atan2(dY1,dX1) * (( (Float)(180) ) / ::Math_obj::PI));
HXLINE( 515)		angle = ::hx::Mod((angle + this->offset),360);
HXLINE( 517)		return angle;
            	}
...
Float RotationPath_obj::get_start(){
            	HX_STACKFRAME(&_hx_pos_1630a997d07a1e21_529_get_start)
HXDLIN( 529)		return this->_start;
            	}
...
Float RotationPath_obj::set_start(Float value){
            	HX_STACKFRAME(&_hx_pos_1630a997d07a1e21_536_set_start)
HXDLIN( 536)		return this->_start;
            	}
...
Float RotationPath_obj::get_end(){
            	HX_STACKFRAME(&_hx_pos_1630a997d07a1e21_543_get_end)
HXDLIN( 543)		return this->calculate(((Float)1.0));
            	}
