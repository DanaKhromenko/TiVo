...
HXLINE(  23)		if (::Std_obj::isOfType( ::Dynamic(properties->__Field(HX_("filter",b8,1f,35,85),::hx::paccDynamic)),::hx::ClassOf< ::hx::Class >())) {
...
HXDLIN(  31)					_g = (_g + 1);
HXLINE(  33)					if (::Std_obj::isOfType(filter,this->filterClass)) {
...
HXLINE( 103)				if (::Std_obj::isOfType(filters->__get(i).StaticCast<  ::openfl::filters::BitmapFilter >(),this->filterClass)) {
