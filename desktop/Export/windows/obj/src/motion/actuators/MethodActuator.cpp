...
HX_LOCAL_STACK_FRAME(_hx_pos_6897cb52bd0f68b1_62_initialize,"motion.actuators.MethodActuator","initialize",0xed23b958,"motion.actuators.MethodActuator.initialize","motion/actuators/MethodActuator.hx",62,0xd19a6596)
HX_LOCAL_STACK_FRAME(_hx_pos_6897cb52bd0f68b1_90_update,"motion.actuators.MethodActuator","update",0x03776a11,"motion.actuators.MethodActuator.update","motion/actuators/MethodActuator.hx",90,0xd19a6596)
namespace motion{
namespace actuators{
...
HXLINE(  47)		if (this->initialized) {
HXLINE(  48)			{
HXLINE(  48)				int _g = 0;
HXDLIN(  48)				int _g1 = ( (int)( ::Dynamic(this->properties->__Field(HX_("start",62,74,0b,84),::hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),::hx::paccDynamic)) );
HXDLIN(  48)				while((_g < _g1)){
HXLINE(  48)					_g = (_g + 1);
HXDLIN(  48)					int i = (_g - 1);
HXLINE(  50)					this->currentParameters->set(i,::Reflect_obj::field(this->tweenProperties,(HX_("param",8d,80,55,bd) + i)));
            				}
            			}
HXLINE(  54)			{
HXLINE(  54)				 ::Dynamic method = this->target;
HXDLIN(  54)				::cpp::VirtualArray params = this->currentParameters;
HXDLIN(  54)				if (::hx::IsNull( params )) {
HXLINE(  54)					params = ::cpp::VirtualArray_obj::__new(0);
            				}
HXDLIN(  54)				::Reflect_obj::callMethod(method,method,params);
            			}
            		}
HXLINE(  57)		this->super::complete(sendEvent);
            	}


void MethodActuator_obj::initialize(){
            	HX_GC_STACKFRAME(&_hx_pos_6897cb52bd0f68b1_62_initialize)
HXLINE(  64)		 ::motion::actuators::PropertyDetails details;
HXLINE(  65)		::String propertyName;
HXLINE(  66)		 ::Dynamic start;
HXLINE(  68)		{
HXLINE(  68)			int _g = 0;
HXDLIN(  68)			int _g1 = ( (int)( ::Dynamic(this->properties->__Field(HX_("start",62,74,0b,84),::hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),::hx::paccDynamic)) );
HXDLIN(  68)			while((_g < _g1)){
HXLINE(  68)				_g = (_g + 1);
HXDLIN(  68)				int i = (_g - 1);
HXLINE(  70)				propertyName = (HX_("param",8d,80,55,bd) + i);
HXLINE(  71)				start =  ::Dynamic(this->properties->__Field(HX_("start",62,74,0b,84),::hx::paccDynamic))->__GetItem(i);
HXLINE(  73)				::Reflect_obj::setField(this->tweenProperties,propertyName,start);
HXLINE(  75)				bool _hx_tmp;
HXDLIN(  75)				if (!(::Std_obj::isOfType(start,::hx::ClassOf< ::Float >()))) {
HXLINE(  75)					_hx_tmp = ::Std_obj::isOfType(start,::hx::ClassOf< int >());
            				}
            				else {
HXLINE(  75)					_hx_tmp = true;
            				}
HXDLIN(  75)				if (_hx_tmp) {
HXLINE(  77)					details =  ::motion::actuators::PropertyDetails_obj::__alloc( HX_CTX ,this->tweenProperties,propertyName,( (Float)(start) ),(( (Float)( ::Dynamic(this->properties->__Field(HX_("end",db,03,4d,00),::hx::paccDynamic))->__GetItem(i)) ) - ( (Float)(start) )),null());
HXLINE(  78)					this->propertyDetails->push(details);
            				}
            			}
            		}
HXLINE(  84)		this->detailsLength = this->propertyDetails->length;
HXLINE(  85)		this->initialized = true;
            	}


void MethodActuator_obj::update(Float currentTime){
            	HX_STACKFRAME(&_hx_pos_6897cb52bd0f68b1_90_update)
HXLINE(  92)		this->super::update(currentTime);
HXLINE(  94)		bool _hx_tmp;
HXDLIN(  94)		if (this->active) {
HXLINE(  94)			_hx_tmp = !(this->paused);
            		}
            		else {
...
HXLINE(  96)			{
HXLINE(  96)				int _g = 0;
HXDLIN(  96)				int _g1 = ( (int)( ::Dynamic(this->properties->__Field(HX_("start",62,74,0b,84),::hx::paccDynamic))->__Field(HX_("length",e6,94,07,9f),::hx::paccDynamic)) );
HXDLIN(  96)				while((_g < _g1)){
HXLINE(  96)					_g = (_g + 1);
HXDLIN(  96)					int i = (_g - 1);
HXLINE(  98)					this->currentParameters->set(i,::Reflect_obj::field(this->tweenProperties,(HX_("param",8d,80,55,bd) + i)));
            				}
            			}
HXLINE( 102)			{
HXLINE( 102)				 ::Dynamic method = this->target;
HXDLIN( 102)				::cpp::VirtualArray params = this->currentParameters;
HXDLIN( 102)				if (::hx::IsNull( params )) {
HXLINE( 102)					params = ::cpp::VirtualArray_obj::__new(0);
            				}
HXDLIN( 102)				::Reflect_obj::callMethod(method,method,params);
            			}
            		}
            	}
