...
HXLINE(  41)			 ::Dynamic target1 = this->target;
HXDLIN(  41)			 ::Dynamic value2 = this->endSoundTransform;
HXDLIN(  41)			if (::Reflect_obj::hasField(target1,HX_("soundTransform",9d,ee,de,22))) {
...
HXLINE(  50)			_hx_tmp = ::Std_obj::isOfType(this->target,::hx::ClassOf< ::openfl::display::DisplayObject >());
            		}
            		else {
...
HXLINE( 127)		 ::Dynamic target1 = this->target;
HXDLIN( 127)		 ::Dynamic value1 = null();
HXDLIN( 127)		if (::Reflect_obj::hasField(target1,HX_("transform",6c,2d,93,45))) {
...
HXDLIN( 127)		 ::openfl::geom::Transform transform = ( ( ::openfl::geom::Transform)(value1) );
HXLINE( 128)		 ::Dynamic value2 = null();
...
HXDLIN( 128)		 ::openfl::geom::ColorTransform begin = ( ( ::openfl::geom::ColorTransform)(value2) );
...
HXDLIN( 134)				_g = (_g + 1);
HXLINE( 136)				 ::Dynamic value3 = null();
...
HXDLIN( 136)				start = ( (Float)(value3) );
HXLINE( 137)				 ::openfl::geom::ColorTransform details1 = this->tweenColorTransform;
HXDLIN( 137)				 ::openfl::geom::ColorTransform target2 = this->endColorTransform;
HXDLIN( 137)				 ::Dynamic value4 = null();
HXDLIN( 137)				if (::Reflect_obj::hasField(target2,propertyName)) {
HXLINE( 137)					value4 = ::Reflect_obj::field(target2,propertyName);
            				}
            				else {
HXLINE( 137)					value4 = ::Reflect_obj::getProperty(target2,propertyName);
            				}
HXDLIN( 137)				details =  ::motion::actuators::PropertyDetails_obj::__alloc( HX_CTX ,details1,propertyName,start,(( (Float)(value4) ) - start),null());
...
HXLINE( 149)			 ::Dynamic target1 = this->target;
HXDLIN( 149)			 ::Dynamic value1 =  ::openfl::media::SoundTransform_obj::__alloc( HX_CTX ,null(),null());
HXDLIN( 149)			if (::Reflect_obj::hasField(target1,HX_("soundTransform",9d,ee,de,22))) {
...
HXLINE( 153)		 ::Dynamic target2 = this->target;
HXDLIN( 153)		 ::Dynamic value2 = null();
HXDLIN( 153)		if (::Reflect_obj::hasField(target2,HX_("soundTransform",9d,ee,de,22))) {
...
HXDLIN( 153)		 ::openfl::media::SoundTransform start = ( ( ::openfl::media::SoundTransform)(value2) );
HXLINE( 154)		 ::Dynamic target3 = this->target;
HXDLIN( 154)		 ::Dynamic value3 = null();
HXDLIN( 154)		if (::Reflect_obj::hasField(target3,HX_("soundTransform",9d,ee,de,22))) {
...
HXDLIN( 154)		this->endSoundTransform = ( ( ::openfl::media::SoundTransform)(value3) );
...
HXLINE( 167)			::Array< ::Dynamic> _hx_tmp1 = this->propertyDetails;
HXDLIN( 167)			_hx_tmp1->push( ::motion::actuators::PropertyDetails_obj::__alloc( HX_CTX ,this->tweenSoundTransform,HX_("pan",5d,51,55,00),start->pan,(this->endSoundTransform->pan - start->pan),null()));
            		}
            	}
...
HXLINE( 187)			 ::Dynamic target1 = this->target;
HXDLIN( 187)			 ::Dynamic value2 = this->tweenSoundTransform;
HXDLIN( 187)			if (::Reflect_obj::hasField(target1,HX_("soundTransform",9d,ee,de,22))) {
